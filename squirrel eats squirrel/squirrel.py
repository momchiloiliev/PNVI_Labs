...
WINWIDTH = 960 # width of the program's window, in pixels #1Барање
WINHEIGHT = 480 # height in pixels #1Барање
...
CAMERASLACKX = 90    # how far from the center the squirrel moves before moving the camera #Барање2
CAMERASLACKY = 45    #Барање2
            ...
            for i in range(len(squirrelObjs)-1, -1, -1):
                ...
                if 'rect' in sqObj and playerObj['rect'].colliderect(sqObj['rect']):
                    ...
                    if sqObj['width'] * sqObj['height'] <= playerObj['size']**2:
                        ...
                        playerObj['health'] -= 0
                        playerObj['size'] -= int( (sqObj['width'] * sqObj['height'])**0.2 ) + 1 #Барање4
                        print(playerObj['size'])
                        if playerObj['size'] <= LOSTSIZE: #Барање4
