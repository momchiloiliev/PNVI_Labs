    ...
    while True: # main game loop
        ...
        for event in pygame.event.get(): # event handling loop
            if event.type == QUIT:
                ...
                # Handle key presses
                keyPressed = True
                if event.key == K_a: #Baranje1
                    playerMoveTo = LEFT
                elif event.key == K_d: #Baranje1
                    playerMoveTo = RIGHT
                elif event.key == K_w: #Baranje1
                    playerMoveTo = UP
                elif event.key == K_s: #Baranje1
                    playerMoveTo = DOWN

                # Set the camera move mode.
                elif event.key == K_LEFT:#Baranje1
                    cameraLeft = True
                elif event.key == K_RIGHT:#Baranje1
                    cameraRight = True
                elif event.key == K_UP:#Baranje1
                    cameraUp = True
                elif event.key == K_DOWN:#Baranje1
                    cameraDown = True
